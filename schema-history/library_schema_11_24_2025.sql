CREATE DATABASE  IF NOT EXISTS `library_team2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `library_team2`;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`db2root`@`%`*/ /*!50003 TRIGGER `trg_copy_available_promote` BEFORE UPDATE ON `copy` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`db2root`@`%`*/ /*!50003 TRIGGER `trg_copy_lost_deactivate` AFTER UPDATE ON `copy` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`db2root`@`%`*/ /*!50003 TRIGGER `trg_reactivate_after_fines` AFTER UPDATE ON `fine` FOR EACH ROW BEGIN
...
CREATE TABLE `notification` (
  ...
  `copy_id` int DEFAULT NULL,
  `type` enum('hold_ready','hold_lifted','room_expiring','room_expired','due_soon','overdue','lost_warning','lost_marked','suspended','system') NOT NULL DEFAULT 'hold_ready',
  ...
  KEY `fk_notification_hold` (`hold_id`),
...
-- Dump completed on 2025-11-24 22:09:15
