...
import { checkout, returnLoan, fetchUserLoans, reqCheckout, listMyPendingCheckouts, listPendingCheckouts, approveCheckout, denyCheckout, cancelRequest } from "./api/loans.js";
...
import { getClientConfig } from "./api/config.js";
...
r.add("GET", "/api/config", getClientConfig());
...
r.add("GET", "/api/loans/myreqs", fetchUserLoans(JWT_SECRET,"requests"));
r.add("GET", "/api/loans/myhist", fetchUserLoans(JWT_SECRET,"history"));
r.add("POST", "/api/loans/request", reqCheckout(JWT_SECRET));
r.add("POST", "/api/loans/request/cancel", cancelRequest(JWT_SECRET));
...
r.add("POST", "/api/staff/loans/deny", denyCheckout(JWT_SECRET));
